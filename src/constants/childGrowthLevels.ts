...
export const PARENT_GUIDES: Record<number, string> = {
  ...
  3:
    '화분에 하트로 물을 주며 키우고 있어요. 보상 없이 돌보기만 하는 유일한 기능이에요.\n\n' +
    '오늘 화분이 얼마나 자랐는지 아이에게 물어봐 주세요.',
  4:
  ...
  6:
    ...
    '그게 첫 금융 수업이 됩니다.',
  7:
    '다음 레벨에서 보물상자가 열려요. 모은 크레딧으로 영상 이용권을 살 수 있게 됩니다.\n\n' +
    '갖고 싶은 것의 가격과 지금 저금통 잔액을 아이와 함께 세어 보세요.',
  8:
    '보물상자가 열렸어요. 모은 크레딧으로 영상 이용권을 직접 살 수 있어요.\n\n' +
    '사고 나서 후회해도 괜찮습니다. 그 후회가 다음 선택을 바꿔요.',
  9:
    '새로 열리는 기능은 없지만, 미션·저금통·마켓·보물상자를 모두 쓸 수 있는 단계예요.\n\n' +
    '처음과 지금 무엇이 달라졌는지 아이에게 말로 짚어 주세요.',
  10:
    '보물상자에 미니게임 이용권이 추가됐어요. 크레딧으로 사서 즐길 수 있어요.\n\n' +
    '저금통과 놀이 사이에서 아이가 어떻게 나누는지 지켜봐 주세요. 균형을 잡는 것도 배움이에요.',
  11:
...
export const PARENT_GUIDE_FALLBACK =
  '지금까지 열린 기능을 모두 쓸 수 있어요. 새로 열리는 기능은 없고, ' +
  '이제 아이의 습관이 앱보다 앞서 가는 단계입니다.\n\n' +
