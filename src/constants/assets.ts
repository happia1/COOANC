...
export const ASSETS = {
  ...
  layouts: {
     ...
     */
    childHomeBackground01: assetImg('layouts', 'backgrounds', 'tablet_kidsroom_background_portrait.png'),
    /**
     * 자녀 앱 홈 탭 풀블리드 배경입니다.
     * - 태블릿 키즈룸 일러스트, 세로(portrait) (`tablet_kidsroom_background_portrait.png`).
     * - 미션·로딩 등 다른 화면의 `sharedAppBackground` 와는 별도 파일이라 교체 시 홈만 바뀝니다.
     */
    childHomeBackgroundSecondScreen: assetImg(
      'layouts',
      'backgrounds',
      'tablet_kidsroom_background_portrait.png',
    ),
    /**
 ...
 */
export const CHILD_HOME_BACKGROUND_CACHE_BUST = '2'
