            ...
            <>
              ...
              >
                {modal.unlocks.map((u) => (
                  <li
                    key={u.id}
                    className="flex flex-col items-center rounded-xl bg-sky-50/90 px-2 py-2.5 ring-1 ring-sky-100"
                  >
                    ...
                    <p className="mt-1 text-center text-[11px] font-black text-gray-800">{u.shortLabel}</p>
                    <p className="mt-0.5 line-clamp-2 text-center text-[10px] leading-snug text-gray-500">
                      {u.description}
                    </p>
                  </li>
                ))}
