...
2.  **메인 화면 (레벨별 적응형 UI)**: 
    *   **Level 1 (만 3~4세)**: 미션 화면에 **저금통 하나만 노출**. 
    *   **Level 2~3 (만 5~7세)**: **저금통과 지갑 동시 등장**.
    *   **Level 4+ (만 8세 이상)**: 독바 확장 (소셜/랭킹 탭 추가), 상단 **기부 나무 노출**.
...
COO-ANC의 핵심은 **단계별 경제 교육 커리큘럼**입니다. 이 커리큘럼은 아동의 연령과 발달 단계에 맞춰 경제 개념을 자연스럽게 습득하고 실천할 수 있도록 설계되었습니다. 제공해주신 대외비 커리큘럼 맵은 AI 에이전트의 **RAG(Retrieval Augmented Generation) 기반 지식 베이스**로 활용되어, 개인화된 교육 경험을 제공합니다.
...
| 단계 | 연령 | 주요 경제 개념 | 미션 예시 | UI/UX 특징 |
| :--- | :--- | :--- | :--- | :--- |
| **Level 1** | 만 3~4세 | 행동-보상 연결 | "장난감 정리하기" → "저금통에 코인 1개" | 저금통 하나만 노출, 큰 아이콘, 사운드 중심 |
| **Level 2** | 만 5~6세 | 저축의 개념 | "간식 참기" → "저금통에 코인 3개" | 저금통 + 지갑 노출, 간단한 텍스트 |
| **Level 3** | 만 7~8세 | 계획 소비 | "마켓에서 원하는 물건 고르기" → "부모님과 상의 후 구매" | 마켓 기능 활성화, 자물쇠/활성화 시각화 |
| **Level 4** | 만 9~11세 | 사회적 경제 활동 | "친구에게 크레딧 선물하기", "기부하기" | 독바 확장, 랭킹, 기부 나무 노출 |
